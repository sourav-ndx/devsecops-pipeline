...
This platform processes real-time traffic for an enterprise platform. Automated production deployment of a platform handling real-time voice traffic is not acceptable — a bad deploy during business hours directly impacts live traffic. Production goes through:
...
│   ├── gitops-variant.md            ← ArgoCD GitOps pipeline variant
